...
| [0047](0047-a-trip-is-when-it-left-and-between-where.md) | A trip is when it left and between where — train code was half the identity and is not stable, so one journey was stored twice; the import now updates a matched trip in place and a migration collapses the 77 pairs |
