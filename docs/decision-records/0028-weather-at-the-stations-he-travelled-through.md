...
- **Amended by:** [0031](0031-drop-the-country-hint-and-check-geocodes-against-the-distances.md) — the country-hint premise below is wrong (viaduct.world records the UTC *offset* zone, not the station's), and the hint has been removed. Everything else here stands.
- **Date:** 2026-08-05
